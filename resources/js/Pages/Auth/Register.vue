            ...
            <div class="max-w-md w-full">
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
                        ...
                        <p class="text-indigo-100 text-sm mt-1">Join SoftNiq to manage your tasks efficiently</p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="px-8 py-6">
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-sm text-gray-600">
                                ...
                                <Link :href="route('login')" class="text-indigo-600 hover:text-indigo-800 font-semibold transition">
                                    Sign in
                                </Link>
                            </p>
                        </div>
